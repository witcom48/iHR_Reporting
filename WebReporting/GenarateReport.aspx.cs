    ...
    public partial class GenarateReport : System.Web.UI.Page
    {
            ...
            try
            {
                ...
                if (objReportjob != null)
                {
                    ...
                    switch (objReportjob.reportjob_type)
                    {
                        ...
                        case "PR5":
                            viewerTax91("PR5.rpt", objReportjob, objList_whose);
                            break;
                        ...
                        case "PR8":
                            viewerKT20("PR8.rpt", objReportjob, objList_whose);
                            break;

                        case "PR9":
                            viewerPA("PR9.rpt", objReportjob, objList_whose);
                            break;
        ...
        public void viewerPA(string rptName, cls_SYSReportjob obj, List<cls_SYSReportjobwhose> objListWhose)
        {
            ...
            try
            {
                ...
                objStr = new StringBuilder();
                objStr.Append(" SELECT *");
                objStr.Append(" FROM HRM_TR_PAYREDUCE");
                objStr.Append(" WHERE COMPANY_CODE='" + obj.company_code + "'");
                objStr.Append(" AND WORKER_CODE IN (" + strEmpID + ")");
                objStr.Append(" AND PAYREDUCE_PAYDATE = '" + obj.reportjob_paydate.ToString("MM/dd/yyyy") + "'");
                dt = objConn.doGetTable(objStr.ToString(), "HRM_TR_PAYREDUCE");
                ds.Tables.Add(dt);

                objStr = new StringBuilder();
                objStr.Append(" SELECT *");
                objStr.Append(" FROM HRM_TR_PAYTAXDETAIL");
                objStr.Append(" WHERE COMPANY_CODE='" + obj.company_code + "'");
                objStr.Append(" AND WORKER_CODE IN (" + strEmpID + ")");
                objStr.Append(" AND PAYTAXDETAIL_PAYDATE = '" + obj.reportjob_paydate.ToString("MM/dd/yyyy") + "'");
                dt = objConn.doGetTable(objStr.ToString(), "HRM_TR_PAYTAXDETAIL");
                ds.Tables.Add(dt);
        ...
        public void viewerPaySlip(string rptName, cls_SYSReportjob obj, List<cls_SYSReportjobwhose> objListWhose)
        {
            ...
            try
            {
                ...
                objStr.Append(", ISNULL(PAYTRAN_NETPAY_B,0) AS NetPayB");
                objStr.Append(", ISNULL(PAYTRAN_NEYPAY_C,0) AS NetPayC");
                objStr.Append(" FROM HRM_TR_PAYTRAN");
                objStr.Append(" WHERE COMPANY_CODE='" + obj.company_code + "'");
                objStr.Append(" AND PAYTRAN_PAYDATE = '" + obj.reportjob_paydate.ToString("MM/dd/yyyy") + "'");
                objStr.Append(" AND WORKER_CODE IN (" + strEmpID + ")");
                ...
                objStr.Append(", WORKER_CODE AS EmpID");
                objStr.Append(", PAYTRAN_PAYDATE AS PayDate");
                objStr.Append(", SUM((ISNULL(PAYTRAN_INCOME_401,0) - ISNULL(PAYTRAN_DEDUCT_401,0)) + (ISNULL(PAYTRAN_INCOME_4012,0) - ISNULL(PAYTRAN_DEDUCT_4012,0)) + (ISNULL(PAYTRAN_INCOME_4013,0) - ISNULL(PAYTRAN_DEDUCT_4013,0)) + (ISNULL(PAYTRAN_INCOME_402I,0) - ISNULL(PAYTRAN_DEDUCT_402I,0)) + (ISNULL(PAYTRAN_INCOME_402O,0) - ISNULL(PAYTRAN_DEDUCT_402O,0))) OVER (partition by WORKER_CODE order by WORKER_CODE,PAYTRAN_PAYDATE) AS incomeFix");
                objStr.Append(", SUM((ISNULL(PAYTRAN_TAX_401,0)+ISNULL(PAYTRAN_TAX_4012,0)+ ISNULL(PAYTRAN_TAX_4013,0)+ISNULL(PAYTRAN_TAX_402I,0)+ISNULL(PAYTRAN_TAX_402O,0))) OVER (partition by WORKER_CODE order by WORKER_CODE,PAYTRAN_PAYDATE) AS Tax");
                objStr.Append(", SUM(ISNULL(PAYTRAN_SSOEMP,0)) OVER (partition by WORKER_CODE order by WORKER_CODE,PAYTRAN_PAYDATE) AS SocialFix");
                objStr.Append(", SUM(ISNULL(PAYTRAN_SSOCOM,0)) OVER (partition by WORKER_CODE order by WORKER_CODE,PAYTRAN_PAYDATE) AS SSOAcc_Com");
                objStr.Append(", SUM(ISNULL(PAYTRAN_PFEMP,0)) OVER (partition by WORKER_CODE order by WORKER_CODE,PAYTRAN_PAYDATE) AS PfAcc");
                objStr.Append(", SUM(ISNULL(PAYTRAN_PFCOM,0)) OVER (partition by WORKER_CODE order by WORKER_CODE,PAYTRAN_PAYDATE) AS PfAcc_Com");
                objStr.Append(" FROM HRM_TR_PAYTRAN ");
                objStr.Append(" WHERE COMPANY_CODE='" + obj.company_code + "'");
                objStr.Append(" AND PAYTRAN_PAYDATE IN (SELECT PERIOD_PAYMENT FROM HRM_MT_PERIOD WHERE YEAR_CODE='" + obj.reportjob_paydate.ToString("yyyy") + "' AND PERIOD_PAYMENT <= '" + obj.reportjob_paydate.ToString("MM/dd/yyyy") + "' )");
                objStr.Append(" AND WORKER_CODE IN (" + strEmpID + ")");
                ...
                objStr.Append(" COMPANY_CODE AS CompID");
                objStr.Append(", WORKER_CODE AS EmpID");
                objStr.Append(", MONTH(PAYOT_DATE) AS PeriodID");
                objStr.Append(", YEAR(PAYOT_DATE) AS PeriodYear");
                objStr.Append(", PAYOT_OT1_AMOUNT AS RateMoney1");
                objStr.Append(", PAYOT_OT15_AMOUNT AS RateMoney2");
                objStr.Append(", PAYOT_OT2_AMOUNT AS RateMoney3");
                objStr.Append(", PAYOT_OT3_AMOUNT AS RateMoney5");
                objStr.Append(" FROM HRM_TR_PAYOT ");
                objStr.Append(" WHERE COMPANY_CODE='" + obj.company_code + "'");
                objStr.Append(" AND WORKER_CODE IN (" + strEmpID + ")");
                objStr.Append(" AND PAYOT_DATE = '" + obj.reportjob_paydate.ToString("MM/dd/yyyy") + "'");
                //objStr.Append(" GROUP BY COMPANY_CODE,WORKER_CODE,YEAR(PAYOT_DATE),MONTH(PAYOT_DATE)");
                dt = objConn.doGetTable(objStr.ToString(), "tbTRPeriodOT");
                ds.Tables.Add(dt);
        ...
        public void viewerTax91(string rptName, cls_SYSReportjob obj, List<cls_SYSReportjobwhose> objListWhose)
        {
            ...
            try
            {
                ...
                CrystalDecisions.Shared.ParameterField param7Field = new ParameterField();
                CrystalDecisions.Shared.ParameterDiscreteValue param7Range = new ParameterDiscreteValue();
                CrystalDecisions.Shared.ParameterField param8Field = new ParameterField();
                CrystalDecisions.Shared.ParameterDiscreteValue param8Range = new ParameterDiscreteValue();
                ...
                if (rptName == "PR5.rpt")
                {
                    param8Field.ParameterFieldName = "EmpType";
                    param8Range.Value = "A";
                    param8Field.CurrentValues.Add(param8Range);
                    paramFields.Add(param8Field);
                }
                else { }
                ...
                objStr.Append(", WORKER_HIREDATE AS WorkStartDate");
                ...
                objStr.Append(", ISNULL((SELECT EMPFAMILY_FNAME_TH FROM HRM_TR_EMPFAMILY WHERE COMPANY_CODE = HRM_MT_WORKER.COMPANY_CODE AND WORKER_CODE = HRM_MT_WORKER.WORKER_CODE AND FAMILY_TYPE = '00' ),'') AS SpoFName");
                objStr.Append(", ISNULL((SELECT EMPFAMILY_LNAME_TH FROM HRM_TR_EMPFAMILY WHERE COMPANY_CODE = HRM_MT_WORKER.COMPANY_CODE AND WORKER_CODE = HRM_MT_WORKER.WORKER_CODE AND FAMILY_TYPE = '00' ),'') AS SpoLName");
                objStr.Append(", ISNULL((SELECT EMPFAMILY_CODE FROM HRM_TR_EMPFAMILY WHERE COMPANY_CODE = HRM_MT_WORKER.COMPANY_CODE AND WORKER_CODE = HRM_MT_WORKER.WORKER_CODE AND FAMILY_TYPE = '00' ),'') AS SpoCardNo");
                objStr.Append(", ISNULL((SELECT EMPFAMILY_BIRTHDATE FROM HRM_TR_EMPFAMILY WHERE COMPANY_CODE = HRM_MT_WORKER.COMPANY_CODE AND WORKER_CODE = HRM_MT_WORKER.WORKER_CODE AND FAMILY_TYPE = '00' ),'') AS SpoBirthDay");

                objStr.Append(", '' AS MaritalTax");
                objStr.Append(", IIF(ISNULL((SELECT EMPFAMILY_CODE FROM HRM_TR_EMPFAMILY WHERE COMPANY_CODE = HRM_MT_WORKER.COMPANY_CODE AND WORKER_CODE = HRM_MT_WORKER.WORKER_CODE AND FAMILY_TYPE = '00' ),'') = '','S','M' ) AS SentTaxStatus");
                ...
                objStr.Append(", ISNULL(PAYTRAN_NETPAY_B,0) AS NetPayB");
                objStr.Append(", ISNULL(PAYTRAN_NEYPAY_C,0) AS NetPayC");
                objStr.Append(", PAYTRAN_INCOME_TOTAL AS TotalAllowanceAll");
                objStr.Append(" FROM HRM_TR_PAYTRAN");
                objStr.Append(" WHERE COMPANY_CODE='" + obj.company_code + "'");
                objStr.Append(" AND PAYTRAN_PAYDATE = '" + obj.reportjob_paydate.ToString("MM/dd/yyyy") + "'");
                objStr.Append(" AND WORKER_CODE IN (" + strEmpID + ")");
                ...
                objStr.Append(", SUM(ISNULL(PAYTRAN_TAX_401,0)) OVER (partition by WORKER_CODE order by WORKER_CODE,PAYTRAN_PAYDATE) AS TaxFortyOne");
                objStr.Append(", SUM(ISNULL(PAYTRAN_TAX_4013,0)) OVER (partition by WORKER_CODE order by WORKER_CODE,PAYTRAN_PAYDATE) AS TaxFortyOnePerThree");
                objStr.Append(", SUM(ISNULL(PAYTRAN_TAX_4012,0)) OVER (partition by WORKER_CODE order by WORKER_CODE,PAYTRAN_PAYDATE) AS TaxFortyOneTwo");
                objStr.Append(", SUM(ISNULL(PAYTRAN_TAX_402I,0)) OVER (partition by WORKER_CODE order by WORKER_CODE,PAYTRAN_PAYDATE) AS TaxFortyTwoIn");
                objStr.Append(", SUM(ISNULL(PAYTRAN_TAX_402O,0)) OVER (partition by WORKER_CODE order by WORKER_CODE,PAYTRAN_PAYDATE) AS TaxFortyTwoOut");
                objStr.Append(", SUM((ISNULL(PAYTRAN_INCOME_401,0) - ISNULL(PAYTRAN_DEDUCT_401,0))) OVER (partition by WORKER_CODE order by WORKER_CODE,PAYTRAN_PAYDATE) AS IncFortyOne");
                objStr.Append(", SUM((ISNULL(PAYTRAN_INCOME_4013,0) - ISNULL(PAYTRAN_DEDUCT_4013,0))) OVER (partition by WORKER_CODE order by WORKER_CODE,PAYTRAN_PAYDATE) AS IncFortyOnePerThree");
                objStr.Append(", SUM((ISNULL(PAYTRAN_INCOME_4012,0) - ISNULL(PAYTRAN_DEDUCT_4012,0))) OVER (partition by WORKER_CODE order by WORKER_CODE,PAYTRAN_PAYDATE) AS IncFortyOneTwo");
                objStr.Append(", SUM((ISNULL(PAYTRAN_INCOME_402I,0) - ISNULL(PAYTRAN_DEDUCT_402I,0))) OVER (partition by WORKER_CODE order by WORKER_CODE,PAYTRAN_PAYDATE) AS IncFortyTwoIn");
                objStr.Append(", SUM((ISNULL(PAYTRAN_INCOME_402O,0) - ISNULL(PAYTRAN_DEDUCT_402O,0))) OVER (partition by WORKER_CODE order by WORKER_CODE,PAYTRAN_PAYDATE) AS IncFortyTwoOut");

                objStr.Append(", 0 AS AccAllwanceNotIncTax");
                ...
                objStr.Append(", ISNULL((SELECT TOP 1 PAYREDUCE_AMOUNT FROM HRM_TR_PAYREDUCE WHERE WORKER_CODE = a.WORKER_CODE AND COMPANY_CODE = a.COMPANY_CODE AND PAYREDUCE_PAYDATE = a.PAYTRAN_PAYDATE AND REDUCE_CODE = '02'),0) AS ReduceSpose ");
                objStr.Append(", ISNULL((SELECT TOP 1 PAYREDUCE_AMOUNT FROM HRM_TR_PAYREDUCE WHERE WORKER_CODE = a.WORKER_CODE AND COMPANY_CODE = a.COMPANY_CODE AND PAYREDUCE_PAYDATE = a.PAYTRAN_PAYDATE AND REDUCE_CODE = '06'),0) AS ReduceMather ");
                objStr.Append(", ISNULL((SELECT TOP 1 PAYREDUCE_AMOUNT FROM HRM_TR_PAYREDUCE WHERE WORKER_CODE = a.WORKER_CODE AND COMPANY_CODE = a.COMPANY_CODE AND PAYREDUCE_PAYDATE = a.PAYTRAN_PAYDATE AND REDUCE_CODE = '05'),0) AS ReduceFather ");
                objStr.Append(", ISNULL((SELECT TOP 1 PAYREDUCE_AMOUNT FROM HRM_TR_PAYREDUCE WHERE WORKER_CODE = a.WORKER_CODE AND COMPANY_CODE = a.COMPANY_CODE AND PAYREDUCE_PAYDATE = a.PAYTRAN_PAYDATE AND REDUCE_CODE = '08'),0) AS ReduceSposeMa ");
                objStr.Append(", ISNULL((SELECT TOP 1 PAYREDUCE_AMOUNT FROM HRM_TR_PAYREDUCE WHERE WORKER_CODE = a.WORKER_CODE AND COMPANY_CODE = a.COMPANY_CODE AND PAYREDUCE_PAYDATE = a.PAYTRAN_PAYDATE AND REDUCE_CODE = '07'),0) AS ReduceSposeFa ");
                objStr.Append(", ISNULL((SELECT TOP 1 PAYREDUCE_AMOUNT FROM HRM_TR_PAYREDUCE WHERE WORKER_CODE = a.WORKER_CODE AND COMPANY_CODE = a.COMPANY_CODE AND PAYREDUCE_PAYDATE = a.PAYTRAN_PAYDATE AND REDUCE_CODE = '03'),0) AS ReduceChild ");
                objStr.Append(", ISNULL((SELECT TOP 1 PAYREDUCE_AMOUNT FROM HRM_TR_PAYREDUCE WHERE WORKER_CODE = a.WORKER_CODE AND COMPANY_CODE = a.COMPANY_CODE AND PAYREDUCE_PAYDATE = a.PAYTRAN_PAYDATE AND REDUCE_CODE = '04'),0) AS ReduceChstudy ");
                objStr.Append(", ISNULL((SELECT TOP 1 PAYREDUCE_AMOUNT FROM HRM_TR_PAYREDUCE WHERE WORKER_CODE = a.WORKER_CODE AND COMPANY_CODE = a.COMPANY_CODE AND PAYREDUCE_PAYDATE = a.PAYTRAN_PAYDATE AND REDUCE_CODE = '15'),0) AS ReduceInterance ");
                objStr.Append(", ISNULL((SELECT TOP 1 PAYREDUCE_AMOUNT FROM HRM_TR_PAYREDUCE WHERE WORKER_CODE = a.WORKER_CODE AND COMPANY_CODE = a.COMPANY_CODE AND PAYREDUCE_PAYDATE = a.PAYTRAN_PAYDATE AND REDUCE_CODE = 'PF'),0) AS ReducePF ");
                objStr.Append(", ISNULL((SELECT TOP 1 PAYREDUCE_AMOUNT FROM HRM_TR_PAYREDUCE WHERE WORKER_CODE = a.WORKER_CODE AND COMPANY_CODE = a.COMPANY_CODE AND PAYREDUCE_PAYDATE = a.PAYTRAN_PAYDATE AND REDUCE_CODE = 'RMF'),0) AS ReduceRMF ");
                objStr.Append(", ISNULL((SELECT TOP 1 PAYREDUCE_AMOUNT FROM HRM_TR_PAYREDUCE WHERE WORKER_CODE = a.WORKER_CODE AND COMPANY_CODE = a.COMPANY_CODE AND PAYREDUCE_PAYDATE = a.PAYTRAN_PAYDATE AND REDUCE_CODE = 'SSF'),0) AS ReduceLTF ");
                objStr.Append(", ISNULL((SELECT TOP 1 PAYREDUCE_AMOUNT FROM HRM_TR_PAYREDUCE WHERE WORKER_CODE = a.WORKER_CODE AND COMPANY_CODE = a.COMPANY_CODE AND PAYREDUCE_PAYDATE = a.PAYTRAN_PAYDATE AND REDUCE_CODE = '22'),0) AS ReduceInterest ");
                objStr.Append(", ISNULL((SELECT TOP 1 PAYREDUCE_AMOUNT FROM HRM_TR_PAYREDUCE WHERE WORKER_CODE = a.WORKER_CODE AND COMPANY_CODE = a.COMPANY_CODE AND PAYREDUCE_PAYDATE = a.PAYTRAN_PAYDATE AND REDUCE_CODE = 'SSO'),0) AS ReduceSocial ");
                objStr.Append(", (SELECT SUM(PAYREDUCE_AMOUNT) FROM HRM_TR_PAYREDUCE where WORKER_CODE = a.WORKER_CODE AND COMPANY_CODE =  a.COMPANY_CODE AND PAYREDUCE_PAYDATE = a.PAYTRAN_PAYDATE AND REDUCE_CODE NOT IN ('30','31')) AS TotalReduce ");
                ...
                //
                //objStr.Append(", ISNULL((SELECT TOP 1 PAYTAXDETAIL_EXPENSE FROM HRM_TR_PAYTAXDETAIL WHERE WORKER_CODE = a.WORKER_CODE AND COMPANY_CODE = a.COMPANY_CODE AND PAYTAXDETAIL_PAYDATE = a.PAYTRAN_PAYDATE),0) AS DeductForty ");
                //objStr.Append(", ISNULL((SELECT TOP 1 PAYTAXDETAIL_TAXANNUALVAR FROM HRM_TR_PAYTAXDETAIL WHERE WORKER_CODE = a.WORKER_CODE AND COMPANY_CODE = a.COMPANY_CODE AND PAYTAXDETAIL_PAYDATE = a.PAYTRAN_PAYDATE),0) AS TaxOneOne ");                
                //objStr.Append(", ISNULL((SELECT TOP 1 PAYTAXDETAIL_TAXACC FROM HRM_TR_PAYTAXDETAIL WHERE WORKER_CODE = a.WORKER_CODE AND COMPANY_CODE = a.COMPANY_CODE AND PAYTAXDETAIL_PAYDATE = a.PAYTRAN_PAYDATE),0) AS TaxNa ");
                objStr.Append(", ISNULL(b.PAYTAXDETAIL_EXPENSE,0) AS DeductForty ");
                objStr.Append(", IIF(b.PAYTAXDETAIL_TAXANNUALFIX > b.PAYTAXDETAIL_TAXANNUALVAR,b.PAYTAXDETAIL_TAXANNUALFIX,b.PAYTAXDETAIL_TAXANNUALVAR) AS TaxOneOne ");
                objStr.Append(", ISNULL(PAYTAXDETAIL_TAXACC ,0) AS TaxNa ");
                objStr.Append(", ISNULL(b.PAYTAXDETAIL_TAXFIX + b.PAYTAXDETAIL_TAXVAR,0) AS TotalTax ");

                objStr.Append(", ISNULL((SELECT TOP 1 PAYREDUCE_AMOUNT FROM HRM_TR_PAYREDUCE WHERE WORKER_CODE = a.WORKER_CODE AND COMPANY_CODE = a.COMPANY_CODE AND PAYREDUCE_PAYDATE = a.PAYTRAN_PAYDATE AND REDUCE_CODE = '30'),0) AS DeductStudy ");
                objStr.Append(", ISNULL((SELECT TOP 1 PAYREDUCE_AMOUNT FROM HRM_TR_PAYREDUCE WHERE WORKER_CODE = a.WORKER_CODE AND COMPANY_CODE = a.COMPANY_CODE AND PAYREDUCE_PAYDATE = a.PAYTRAN_PAYDATE AND REDUCE_CODE = '31'),0) AS DeductDonation ");

                objStr.Append(", ISNULL((SELECT TOP 1 PAYREDUCE_AMOUNT FROM HRM_TR_PAYREDUCE WHERE WORKER_CODE = a.WORKER_CODE AND COMPANY_CODE = a.COMPANY_CODE AND PAYREDUCE_PAYDATE = a.PAYTRAN_PAYDATE AND REDUCE_CODE = '10'),0) AS RInsuFaEmp ");
                objStr.Append(", ISNULL((SELECT TOP 1 PAYREDUCE_AMOUNT FROM HRM_TR_PAYREDUCE WHERE WORKER_CODE = a.WORKER_CODE AND COMPANY_CODE = a.COMPANY_CODE AND PAYREDUCE_PAYDATE = a.PAYTRAN_PAYDATE AND REDUCE_CODE = '11'),0) AS RInsuMoEmp ");
                objStr.Append(", ISNULL((SELECT TOP 1 PAYREDUCE_AMOUNT FROM HRM_TR_PAYREDUCE WHERE WORKER_CODE = a.WORKER_CODE AND COMPANY_CODE = a.COMPANY_CODE AND PAYREDUCE_PAYDATE = a.PAYTRAN_PAYDATE AND REDUCE_CODE = '12'),0) AS RInsuFaSpo ");
                objStr.Append(", ISNULL((SELECT TOP 1 PAYREDUCE_AMOUNT FROM HRM_TR_PAYREDUCE WHERE WORKER_CODE = a.WORKER_CODE AND COMPANY_CODE = a.COMPANY_CODE AND PAYREDUCE_PAYDATE = a.PAYTRAN_PAYDATE AND REDUCE_CODE = '13'),0) AS RInsuMoSpo ");
                ...
                objStr.Append(", SUM(0) AS Pension");
                objStr.Append(", SUM(0) AS Funds");
                ...
                objStr.Append(" FROM HRM_MT_DEP");
                objStr.Append(" WHERE COMPANY_CODE='" + obj.company_code + "'");
                objStr.Append(" AND DEP_LEVEL='01'");
                dt = objConn.doGetTable(objStr.ToString(), "vwLevel01");
                ds.Tables.Add(dt);
                ...
                objStr.Append(" FROM HRM_MT_DEP");
                objStr.Append(" WHERE COMPANY_CODE='" + obj.company_code + "'");
                objStr.Append(" AND DEP_LEVEL='02'");
                dt = objConn.doGetTable(objStr.ToString(), "vwLevel02");
                ds.Tables.Add(dt);
                ...
                //    _RD.ExportToHttpResponse(formatType, Response, true, "TAX91");
                //    Response.End();
        ...
        public void viewerKT20(string rptName, cls_SYSReportjob obj, List<cls_SYSReportjobwhose> objListWhose)
        {
            string strError = "viewer1";
            try
            {
                ...
                objStr = new StringBuilder();
                objStr.Append(" SELECT *");
                objStr.Append(" FROM HRM_TR_COMBANK");
                objStr.Append(" WHERE COMPANY_CODE='" + obj.company_code + "'");
                dt = objConn.doGetTable(objStr.ToString(), "HRM_TR_COMBANK");
                ds.Tables.Add(dt);

                objStr = new StringBuilder();
                objStr.Append(" SELECT *");
                objStr.Append(" FROM HRM_TR_KT20_EMP");
                objStr.Append(" WHERE COMPANY_CODE='" + obj.company_code + "'");
                objStr.Append(" AND WORKER_CODE IN (" + strEmpID + ")");
                dt = objConn.doGetTable(objStr.ToString(), "HRM_TR_KT20_EMP");
                ds.Tables.Add(dt);

                objStr = new StringBuilder();
                objStr.Append(" SELECT *");
                objStr.Append(" FROM HRM_TR_KT20_SUMMARY");
                objStr.Append(" WHERE COMPANY_CODE='" + obj.company_code + "'");
                objStr.Append(" AND YEAR_CODE ='" + obj.reportjob_paydate.ToString("yyyy") + "'");
                dt = objConn.doGetTable(objStr.ToString(), "HRM_TR_KT20_SUMMARY");
                ds.Tables.Add(dt);
