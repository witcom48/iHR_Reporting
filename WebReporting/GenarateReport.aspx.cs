    ...
    public partial class GenarateReport : System.Web.UI.Page
    {
        ...
        public void viewerTax91(string rptName, cls_SYSReportjob obj, List<cls_SYSReportjobwhose> objListWhose)
        {
            ...
            try
            {
                ...
                objStr.Append(", (SELECT SUM(PAYREDUCE_AMOUNT) FROM HRM_TR_PAYREDUCE where WORKER_CODE = a.WORKER_CODE AND COMPANY_CODE =  a.COMPANY_CODE AND PAYREDUCE_PAYDATE = a.PAYTRAN_PAYDATE) AS TotalReduce ");
                ...
                objStr.Append(", ISNULL((SELECT TOP 1 PAYTAXDETAIL_NETANNUAL FROM HRM_TR_PAYTAXDETAIL WHERE WORKER_CODE = a.WORKER_CODE AND COMPANY_CODE = a.COMPANY_CODE AND PAYTAXDETAIL_PAYDATE = a.PAYTRAN_PAYDATE),0) AS TaxOneOne ");
